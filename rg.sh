...
echo "Assemble the module getfrequency.asm"
nasm -f elf64 -o clock_speed.o clock_speed.asm -g -gdwarf
...
g++ -m64 -no-pie -o frequency.out isfloat.o clocks.o time.o clock_speed -std=c++17 -g #look up version
